...
class Configure():
    def __init__(self, pathdata):
        ...
        self.cols_train = ["ID","Sepal_Length","Sepal_Width","Petal_Length","Petal_Width","Label_versicolor"]
        ...
        # -- columns ny to 01
        self.cols_nyto01 = ["Label_versicolor"]
        print("Feature Engineering (cols yn to 01) done==========")
        
        # -- column set ID 
        self.col_id = "ID"
        # -- column set Y 
        self.col_y = "Label_versicolor"
        ...
        self.columns_valid_keep = ["ID", "Sepal_Length", "Label_versicolor"]
        self.columns_drop = ["ID", "Label_versicolor"]
